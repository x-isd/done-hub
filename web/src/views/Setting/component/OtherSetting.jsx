  ...
  const checkUpdate = async () => {
    try {
      ...
      if (import.meta.env.VITE_APP_VERSION.startsWith('v')) {
        const res = await API.get('https://api.github.com/repos/deanxv/done-api/releases/latest');
        ...
        const res = await API.get('https://api.github.com/repos/deanxv/done-api/commits/main');
